function new_event_list = screening_vol_contractor (event_list,screen_vol_type,screen_vol_dim,space_cat)
...
new_event_list(length(event_list)) = Conjunction_event;
...
for j=1:length(event_list)
    ...
    [~,T_eci2rsw] = ECI2RSW(state_car1(1:3),state_car1(4:6));
    pos = T_eci2rsw*pos; %Right?
