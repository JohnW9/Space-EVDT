...
%
% INPUT:
%   new_oe_primary = new orbital elements of primary spacecraft
%   new_oe_secondary = new orbital elements of secondary spacecraft
%   current_cdm = current CDM under consideration
