...
if ~iscell(post_maneuver_list_v_based)
    post_maneuver_list_v_based = {post_maneuver_list_v_based};
end

if ~iscell(post_maneuver_list_id_based)
    post_maneuver_list_id_based = {post_maneuver_list_id_based};
end
