...
%% === Part 0:  Input Management and Setup Initial Values ==========================================================
   ...
   % end
    ...
    EDRBin=EDRBinDetermination(CDM.EDR);
    EDRBin=abs(EDRBin);
...
%% === Part I:  model settings check ================================================================
   ...
   if ~isempty(ind)
    ...
    if EDRBin<=1
        if abs(CDM.(['SRP' Input_Object_Designator]))>=ODQualityThresholds.SRPReasonabilityEDR01(ObjectType,1) && ...
           abs(CDM.(['SRP' Input_Object_Designator]))<=ODQualityThresholds.SRPReasonabilityEDR01(ObjectType,2)
        ...
        if abs(CDM.(['SRP' Input_Object_Designator]))>=ODQualityThresholds.SRPReasonabilityEDRGT1(ObjectType,1) && ...
            abs(CDM.CDM.(['SRP' Input_Object_Designator]))<=ODQualityThresholds.SRPReasonabilityEDRGT1(ObjectType,2)
            CurrentEval.ModelSettings.SRPReasonability=1;
        else
            CurrentEval.ModelSettings.SRPReasonability=0; 
        end
