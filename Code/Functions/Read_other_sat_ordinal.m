...
%
% DESCRIPTION:
%   This function defines the details of other satellites for the
...
%   
% OUTPUT:
%   other_sat = (N objects) List of other satellites
%
...
function other_sat = Read_other_sat_ordinal()
config = GetConfig;
other_sat(3) = NASA_sat;

other_sat(1).id = 51070;
other_sat(1).name = 'ICEYE-X14';
other_sat(1).dimensions=[0.7,3,25]; % from Gunter's space page
other_sat(1).mass = 70; % from Gunter's space page
other_sat(1).cost= 5; % no clear info on that, price estimated from article: https://www.bbc.com/news/science-environment-42648391
